apcalc : argument.o driver.o allocator.o number.o add.o subtract.o operation.o multiply.o
	gcc -Wall argument.o driver.o allocator.o number.o add.o subtract.o operation.o multiply.o -o apcalc
